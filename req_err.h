...
// Parameter not valid
const int LCR_PARAM_INVALID = -8;
// No AG-DSP in the system
const int LCR_NO_AGDSP = -9;
// No MINIAP in the system
const int LCR_NO_MINIAP = -10;
// No MIPI Log in the system
const int LCR_NO_MIPI_LOG = -11;
// No MINIAP in the system
const int LCR_NO_ORCA = -12;
// Transaction started
