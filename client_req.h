...
/*  parse_modem_set - parse the CP types.
 *
 *  Return Value:
 *    0: success
 *    -1: invalid CP type, or the number of CP types exceeds the number
 *        of elements in ModemSet::modems, or there are duplicate CP
 *        types in the req buffer.
 */
